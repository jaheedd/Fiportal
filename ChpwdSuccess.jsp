...
<body>
	<s:form id="chpwdSuccessForm" method="post" target="actionMsg">
		<center>
		<sj:div id="actionMsg" effect="pulsate" cssClass="actionMessageChPwd">Password changed successfully. Please login again!</sj:div>
